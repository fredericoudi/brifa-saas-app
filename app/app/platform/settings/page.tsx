        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-border bg-panelAlt/60 p-4">
              ...
              <p className="mt-2 text-sm font-medium text-text">/app/platform</p>
              <p className="mt-1 text-sm text-muted">
                Os caminhos antigos do master podem redirecionar, mas o ponto oficial do super admin agora vive sob `/app`.
              </p>
            </div>
